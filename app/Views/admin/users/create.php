...
<div class="relative mb-10 overflow-hidden rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 p-8">
    ...
    <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div class="text-white">
            <h1 class="text-5xl font-bold leading-tight mb-2">Create User</h1>
            <p class="text-indigo-100 text-xl">Add a new user to the system</p>
        </div>
...
<div class="bg-white rounded-xl shadow-md transition-all duration-300 hover:shadow-lg mb-10">
    <form action="<?php echo base_url('admin/users/create') ?>" method="post" enctype="multipart/form-data" class="p-6">
        <?php echo csrf_field() ?>
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h3 class="text-xl font-semibold text-gray-900">New User Account</h3>
                <p class="text-gray-500">Create a new user with custom permissions</p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="flex items-center mt-2">
                        <input type="checkbox" id="email_verified" name="email_verified" value="1" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500" <?php echo old('email_verified') ? 'checked' : '' ?>>
                ...
                <div>
                    ...
                    <?php endif; ?>
                    <div class="flex items-center mt-2">
                        <input type="checkbox" id="phone_verified" name="phone_verified" value="1" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500" <?php echo old('phone_verified') && old('phone_verified') ? 'checked' : '' ?>>
                    ...
                    <div class="relative">
                        ...
                        <?php if ($userRole === 'admin'): ?>
                            <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 p-2.5<?php echo session('errors.role') ? 'border-red-500' : '' ?>"
                                ...
                                <option value="editor" <?php echo old('role') === 'editor' ? 'selected' : '' ?>>Editor</option>
                                <option value="user" <?php echo old('role') === 'user' ? 'selected' : '' ?>>User</option>
                            </select>
                        <?php else: ?>
                            <input type="hidden" name="role" value="editor">
                            <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 p-2.5" value="Editor" disabled>
                        <?php endif; ?>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 p-2.5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 <?php echo session('errors.status') ? 'border-red-500' : '' ?>"
                            ...
                            <option value="banned" <?php echo old('status') === 'banned' ? 'selected' : '' ?>>Banned</option>
                        </select>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="is_verified" value="1" class="form-checkbox h-5 w-5 text-indigo-600" <?php echo old('is_verified') == '1' ? 'checked' : '' ?>>
        ...
        <div class="flex flex-col sm:flex-row sm:justify-end sm:items-center gap-4 pt-4 border-t border-gray-200">
