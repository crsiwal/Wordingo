        ...
        <div class="text-white">
            ...
            <div class="flex items-center mt-4 text-blue-100">
                ...
                <span class="flex items-center mr-6">
                    ...
                    <a href="<?php echo base_url('admin/posts?s=published'); ?>" class="text-blue-100">
                        <?php echo $publishedPosts; ?> Published
                    </a>
                </span>
                <span class="flex items-center">
                    <i class="fas fa-pencil-alt text-yellow-500 mr-2"></i>
                    <a href="<?php echo base_url('admin/posts?s=draft'); ?>" class="text-blue-100">
    ...
    <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <form id="mainFilterForm" action="<?php echo base_url('admin/posts') ?>" method="get" class="relative flex-grow flex items-center gap-2">
            ...
            <div class="flex flex-grow">
                <input type="text" name="q" value="<?php echo esc($queryParams['q'] ?? '') ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Search posts...">
