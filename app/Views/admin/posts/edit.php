...
<?php echo $this->section('content') ?>
    <div class="mb-8">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo base_url('admin/posts') ?>" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         <?php echo session('errors.content') ? 'border-red-500' : 'border-gray-300' ?>"
                                id="content"
                                name="content"
                                rows="10"><?php echo old('content') ?></textarea>
                    ...
                    <div class="space-y-6">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div>
                                <!-- Upload Section -->
                                <div id="featured_image_upload_section" class="<?php echo empty($post['featured_image_url']) ? '' : 'hidden'; ?>">
                                    <label class="block text-sm font-medium text-gray-700 mb-2" for="featured_image">
                                        Upload Image
                                    </label>
                                    <div class="mb-3">
                                        <input class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 border-gray-300"
                                ...
                                <div id="featured_image_preview" class="mt-4 mb-3 relative                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       <?php echo empty($post['featured_image_url']) ? 'hidden' : ''; ?>">
                                    ...
                                    <img id="featured_image_preview_img" src="" alt="Featured image preview" class="w-full h-auto rounded-lg">
                                </div>
                                ...
                                <input type="hidden" id="featured_image_url" name="featured_image_url" value="<?php echo old('featured_image_url', $post['featured_image_url'] ?? ''); ?>">
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 <?php echo session('errors.category_id') ? 'border-red-500' : 'border-gray-300' ?>"
                                        id="category_id"
                                        name="category_id"
                                        required>
                                ...
                                <div>
                                    ...
                                    <input type="hidden" name="tags" id="tags-hidden" value="<?php echo old('tags') ?>">
