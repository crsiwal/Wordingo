...
<div class="dashboard-container">
    <div class="mb-10 animate-fade-in">
        <h1 class="text-5xl font-extrabold leading-tight tracking-tight text-gray-900 bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent">Manager Dashboard</h1>
    ...
    $stats = [
        ...
        ['label' => 'Team Members', 'value' => $teamMembersCount, 'icon' => 'fa-users', 'color' => 'bg-pink-100 text-pink-600', 'gradient' => 'from-pink-500 to-pink-600'],
        ['label' => 'Active Editors', 'value' => $activeEditors, 'icon' => 'fa-user-check', 'color' => 'bg-purple-100 text-purple-600', 'gradient' => 'from-purple-500 to-purple-600'],
        ['label' => 'Categories', 'value' => $totalCategories, 'icon' => 'fa-folder', 'color' => 'bg-indigo-100 text-indigo-600', 'gradient' => 'from-indigo-500 to-indigo-600'],
    ];
    ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">Your team editors</p>
                    </div>
                    <a href="<?= base_url('admin/team') ?>" class="text-pink-600 hover:text-pink-700 font-semibold transition-colors duration-200 flex items-center gap-2 group">
                        View All <i class="fas fa-arrow-right text-sm group-hover:translate-x-1 transition-transform"></i>
                    </a>
                </div>
                <div class="space-y-4">
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 animate-fade-in group"
                            ...
                            <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex flex-col gap-1.5 text-sm text-gray-500 mt-1.5">
                                            ...
                                            <div class="flex items-center gap-2 flex-wrap">
                                                <div class="flex items-center gap-1.5">
                                                    <i class="fas fa-file-alt"></i>
                                                    <span><?= number_format($member['total_posts']) ?> posts</span>
                                                </div>
                                                <div class="flex items-center gap-1.5">
                                                    <i class="fas fa-eye"></i>
                                                    <span><?= number_format($member['total_views']) ?> views</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center gap-2 ml-4">
                                    <a href="<?= base_url('admin/team/edit/' . $member['id']) ?>"
