    ...
    <div class="max-w-2xl w-full mx-auto p-8">
        <div class="bg-gray-800 rounded-lg shadow-2xl p-8 text-center relative overflow-hidden">
            ...
            <div class="mb-8 relative">
                <div class="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-pulse">System Error</div>
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-6xl opacity-10 blur-sm text-white">System Error</div>
            </div>

            <div class="space-y-6">
                <div class="relative">
                    <h2 class="text-3xl font-bold text-white mb-4">Oops! Something went wrong</h2>
                    <p class="text-gray-400 text-lg">We're sorry, but something went wrong. Our team has been notified and we're working to fix it.</p>
                </div>
                ...
                <div class="mt-8 text-gray-500">
                    <p class="text-sm">Error Code: <span class="font-mono">SYSTEM_ERROR</span></p>
                </div>
            </div>
