    ...
    <div class="max-w-2xl w-full mx-auto p-8">
        <div class="bg-gray-800 rounded-lg shadow-2xl p-8 text-center relative overflow-hidden">
            ...
            <div class="mb-8 relative">
                <div class="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-pulse">Exception</div>
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-6xl opacity-10 blur-sm text-white">Exception</div>
            </div>

            <div class="space-y-6">
                <div class="relative">
                    <h2 class="text-3xl font-bold text-white mb-4">Oops! Something went wrong</h2>
                    <p class="text-gray-400 text-lg"><?= esc($message) ?></p>
                </div>
                ...
                <?php if (ENVIRONMENT !== 'production'): ?>
                    <div class="bg-gray-700 p-4 rounded-lg text-left mb-6">
                        ...
                        <div class="mt-4 text-sm text-gray-300">
                            <strong class="text-white">File:</strong> <?= esc($exception->getFile()) ?><br>
                            <strong class="text-white">Line:</strong> <?= $exception->getLine() ?>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="flex justify-center space-x-4 mt-8">
                    ...
                    <a href="<?= base_url() ?>" class="group relative inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-lg transition-all duration-200">
                ...
                <div class="mt-8 text-gray-500">
                    <p class="text-sm">Error Code: <span class="font-mono">EXCEPTION_ERROR</span></p>
                </div>
            </div>
