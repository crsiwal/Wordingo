    ...
    <div class="max-w-2xl w-full mx-auto p-8">
        <div class="bg-gray-800 rounded-lg shadow-2xl p-8 text-center relative overflow-hidden">
            ...
            <div class="mb-8 relative">
                <div class="text-9xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-pulse">403</div>
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-9xl opacity-10 blur-sm text-white">403</div>
            </div>

            <div class="space-y-6">
                <div class="relative">
                    <h2 class="text-3xl font-bold text-white mb-4">Access Denied!</h2>
                    <p class="text-gray-400 text-lg">Sorry, you don't have permission to access this page. Please make sure you're logged in with the correct permissions.</p>
                </div>
                ...
                <div class="mt-8 text-gray-500">
                    <p class="text-sm">Error Code: <span class="font-mono">ACCESS_DENIED_403</span></p>
                </div>
            </div>
